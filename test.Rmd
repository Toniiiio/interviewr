...
insert_provided_code <- function(code_string, opts){
...
insert_code_result_hint <- function(params){
  ...
  if(no_code){
    ...
    insert_provided_code(code_string, opts)
...
for(nr in seq(questions)){
  ...
  insert_code_result_hint(params)
